...
public partial class _Photos_By_Tag : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string tag_title;
        if (Request.Form.Keys.Count > 0 && !string.IsNullOrEmpty(Request.Form[Request.Form.AllKeys[0]]))
        {
            tag_title = Request.Form[Request.Form.AllKeys[0]];
            Page.RouteData.Values["tag"] = tag_title;
        } else
        {
            tag_title = Page.RouteData.Values["tag"] as string;
        }
